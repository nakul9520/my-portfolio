...
export default function AboutPage() {
  return (
    <>
      {/* Page header */}
      <section
        className="page-header bg-hero-gradient"
      ...
      >
        <div className="container-site">
          ...
          >
            Building the web,{" "}
            <span className="text-gradient">one component</span> at a time
          </h1>
          <p
          ...
          <div>
            ...
            >
              {[
                ...
                {
                  label: "Experience",
                  value: `${personal.yearsExperience} years`,
                },
                { label: "Email", value: personal.email },
                { label: "MCA", value: "SAGE University, Indore (CGPA: 8.06)" },
                {
                  label: "BCA",
                  value: "Suyash Computer, Dhamnod (CGPA: 7.10)",
                },
              ].map(({ label, value }) => (
              ...
              >
                ...
                >
                  {group.skills.map((skill) => (
                    <Badge key={skill} variant="neutral" color="#8b5cf6">
                      {skill}
                    </Badge>
                  ))}
                </div>
